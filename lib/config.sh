...
CONFIG_VARS=(
  ...
  "INSTALL_OPTIMIZE|bool"  "OPTIMIZE_NET|bool"  "OPTIMIZE_COMPRESSION|bool"  "OPTIMIZE_PHP_JIT|bool"  "OPTIMIZE_MARIADB|bool"  "OPTIMIZE_MPM_EVENT|bool"
  "TRUSTED_IPS|str"
...
declare -A MODULE_DEFAULTS=(
  ...
  [INSTALL_OPTIMIZE]=true  [OPTIMIZE_NET]=true  [OPTIMIZE_COMPRESSION]=true  [OPTIMIZE_PHP_JIT]=true  [OPTIMIZE_MARIADB]=true  [OPTIMIZE_MPM_EVENT]=true
  [TRUSTED_IPS]=""
