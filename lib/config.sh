...
CONFIG_VARS=(
  ...
  "INSTALL_MODSEC_CRS|bool"  "MODSEC_ENFORCE|bool"  "INSTALL_APPARMOR|bool"  "INSTALL_AUDITD|bool"
...
declare -A MODULE_DEFAULTS=(
  ...
  [INSTALL_MODSEC_CRS]=true  [MODSEC_ENFORCE]=false  [INSTALL_APPARMOR]=true  [INSTALL_AUDITD]=true
